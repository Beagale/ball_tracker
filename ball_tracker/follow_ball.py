...
#         self.declare_parameter("ball_lost_grid_timeout", 5.0)  # Switch to grid after 5 sec

#         # TEST: Declare parameter for when robot (self) reaches desired grid point
#         self.declare_parameter("reached_grid_point", False)
...
#         # TEST: Implement flag for when robot reaches desired grid point
#         self.reached_point = self.get_parameter('reached_grid_point').get_parameter_value().bool_value
...
#             (2.0, 5.5),   # Center left
#             (2.0, 9.0),   # Back left
#             (4.4, 2.0),   # Front center
#             (4.4, 5.5),   # Center
#             (4.4, 9.0),   # Back center
#             (6.4, 2.0),   # Front right
#             (6.4, 5.5),   # Center right
#             (6.4, 9.0),   # Back right
#         ]
...
#         # Mode tracking
#         self.current_mode = 'SEARCH'  # 'FOLLOW', 'SEARCH', or 'GRID' 
        
#         # Timer
#         timer_period = 0.1  # seconds
#         self.timer = self.create_timer(timer_period, self.timer_callback)
        
#         self.get_logger().info('Follow Ball with Grid Navigation initialized')
...
#         elif time_since_ball < self.ball_lost_grid_timeout: # TEST: or self.current_mode == 'GRID 2 SEARCH': # TEST: The or statement is to allow bot to rotate at reached grid point
...
#             # TEST: Update the flag for when robot reaches point
